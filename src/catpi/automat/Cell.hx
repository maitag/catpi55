...
enum abstract CellType(Int) from Int to Int {
	...
	public function toString():String return catpi.util.EnumMacro.nameByValue(catpi.automat.CellType).get(this);
}
...
abstract CellActor(Int) from Int to Int {
	...
	public static inline var bits:Int = catpi.util.BitUtil.bitsize(MAX_ACTORS);
