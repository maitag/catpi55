...
@:genericBuild(catpi.util.pool.ObjectPool.ObjectPoolMacro.buildModule(AoS))
 ...
 */
@:genericBuild(catpi.util.pool.ObjectPool.ObjectPoolMacro.buildModule(SoA))
