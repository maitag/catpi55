...
{
	public function toConfigVector(sheets:Array<Sheet>):{conf:Vector<ActorElemConfig>, renderTypeSheets:Map<ActorRenderType, Array<Int>>, maxActions:Int} {
		...
		return {conf:conf, renderTypeSheets:renderTypeSheets, maxActions:maxActions};
	}
}

@:structInit @:publicFields
class ActorElemConfig {
	var renderType:ActorRenderType;
	var tileStart:Int;
	var tileEnd:Int;
	var sheetNr:Int;
	var width:Int;
