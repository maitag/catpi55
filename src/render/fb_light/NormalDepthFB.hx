...
abstract NormalDepthFB(Display) to Display
{
	...
	{
		if (this.fbTexture == null) this.setFramebuffer(new Texture(this.width, this.height, 1, {format:TextureFormat.FLOAT_RGBA, smoothExpand: false, smoothShrink: false, powerOfTwo: false} ), peoteView);
